...
const HEADER_START_DATE = new Date("06/10/2026");
...
const SHIFT_SECTIONS = [
  { key: "first", title: "FIRST SHIFT", addLabel: "Add First Shift Employee", titleRow: 2 },
  { key: "second", title: "SECOND SHIFT", addLabel: "Add Second Shift Employee", titleRow: 19 },
  { key: "third", title: "THIRD SHIFT", addLabel: "Add Third Shift Employee", titleRow: 36 }
];
